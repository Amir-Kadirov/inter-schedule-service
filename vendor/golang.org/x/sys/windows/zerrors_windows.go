...
const (
	...
	ERROR_LAST_Student                                                          syscall.Errno = 1322
	...
	ERROR_NO_Student_ACCESS_POINT                                               syscall.Errno = 5090
	...
	ERROR_DS_Student_LIMIT_EXCEEDED                                             syscall.Errno = 8228
	...
	ERROR_PACKAGED_SERVICE_REQUIRES_Student_PRIVILEGES                          syscall.Errno = 15656
	...
	CS_E_Student_LIMIT_EXCEEDED                                                 Handle        = 0x8004016D
	...
	CERTSRV_E_NO_CAStudent_DEFINED                                              Handle        = 0x8009400D
	...
	CERTSRV_E_Student_DENIED_REQUEST                                            Handle        = 0x80094014
	...
	COMStudent_E_OBJECTERRORS                                                   Handle        = 0x80110401
	COMStudent_E_OBJECTINVALID                                                  Handle        = 0x80110402
	COMStudent_E_KEYMISSING                                                     Handle        = 0x80110403
	COMStudent_E_ALREADYINSTALLED                                               Handle        = 0x80110404
	COMStudent_E_APP_FILE_WRITEFAIL                                             Handle        = 0x80110407
	COMStudent_E_APP_FILE_READFAIL                                              Handle        = 0x80110408
	COMStudent_E_APP_FILE_VERSION                                               Handle        = 0x80110409
	COMStudent_E_BADPATH                                                        Handle        = 0x8011040A
	COMStudent_E_APPLICATIONEXISTS                                              Handle        = 0x8011040B
	COMStudent_E_ROLEEXISTS                                                     Handle        = 0x8011040C
	COMStudent_E_CANTCOPYFILE                                                   Handle        = 0x8011040D
	COMStudent_E_NOUSER                                                         Handle        = 0x8011040F
	COMStudent_E_INVALIDUSERIDS                                                 Handle        = 0x80110410
	COMStudent_E_NOREGISTRYCLSID                                                Handle        = 0x80110411
	COMStudent_E_BADREGISTRYPROGID                                              Handle        = 0x80110412
	COMStudent_E_AUTHENTICATIONLEVEL                                            Handle        = 0x80110413
	COMStudent_E_USERPASSWDNOTVALID                                             Handle        = 0x80110414
	COMStudent_E_CLSIDORIIDMISMATCH                                             Handle        = 0x80110418
	COMStudent_E_REMOTEINTERFACE                                                Handle        = 0x80110419
	COMStudent_E_DLLREGISTERSERVER                                              Handle        = 0x8011041A
	COMStudent_E_NOSERVERSHARE                                                  Handle        = 0x8011041B
	COMStudent_E_DLLLOADFAILED                                                  Handle        = 0x8011041D
	COMStudent_E_BADREGISTRYLIBID                                               Handle        = 0x8011041E
	COMStudent_E_APPDIRNOTFOUND                                                 Handle        = 0x8011041F
	COMStudent_E_REGISTRARFAILED                                                Handle        = 0x80110423
	COMStudent_E_COMPFILE_DOESNOTEXIST                                          Handle        = 0x80110424
	COMStudent_E_COMPFILE_LOADDLLFAIL                                           Handle        = 0x80110425
	COMStudent_E_COMPFILE_GETCLASSOBJ                                           Handle        = 0x80110426
	COMStudent_E_COMPFILE_CLASSNOTAVAIL                                         Handle        = 0x80110427
	COMStudent_E_COMPFILE_BADTLB                                                Handle        = 0x80110428
	COMStudent_E_COMPFILE_NOTINSTALLABLE                                        Handle        = 0x80110429
	COMStudent_E_NOTCHANGEABLE                                                  Handle        = 0x8011042A
	COMStudent_E_NOTDELETEABLE                                                  Handle        = 0x8011042B
	COMStudent_E_SESSION                                                        Handle        = 0x8011042C
	COMStudent_E_COMP_MOVE_LOCKED                                               Handle        = 0x8011042D
	COMStudent_E_COMP_MOVE_BAD_DEST                                             Handle        = 0x8011042E
	COMStudent_E_REGISTERTLB                                                    Handle        = 0x80110430
	COMStudent_E_SYSTEMAPP                                                      Handle        = 0x80110433
	COMStudent_E_COMPFILE_NOREGISTRAR                                           Handle        = 0x80110434
	COMStudent_E_COREQCOMPINSTALLED                                             Handle        = 0x80110435
	COMStudent_E_SERVICENOTINSTALLED                                            Handle        = 0x80110436
	COMStudent_E_PROPERTYSAVEFAILED                                             Handle        = 0x80110437
	COMStudent_E_OBJECTEXISTS                                                   Handle        = 0x80110438
	COMStudent_E_COMPONENTEXISTS                                                Handle        = 0x80110439
	COMStudent_E_REGFILE_CORRUPT                                                Handle        = 0x8011043B
	COMStudent_E_PROPERTY_OVERFLOW                                              Handle        = 0x8011043C
	COMStudent_E_NOTINREGISTRY                                                  Handle        = 0x8011043E
	COMStudent_E_OBJECTNOTPOOLABLE                                              Handle        = 0x8011043F
	COMStudent_E_APPLID_MATCHES_CLSID                                           Handle        = 0x80110446
	COMStudent_E_ROLE_DOES_NOT_EXIST                                            Handle        = 0x80110447
	COMStudent_E_START_APP_NEEDS_COMPONENTS                                     Handle        = 0x80110448
	COMStudent_E_REQUIRES_DIFFERENT_PLATFORM                                    Handle        = 0x80110449
	COMStudent_E_CAN_NOT_EXPORT_APP_PROXY                                       Handle        = 0x8011044A
	COMStudent_E_CAN_NOT_START_APP                                              Handle        = 0x8011044B
	COMStudent_E_CAN_NOT_EXPORT_SYS_APP                                         Handle        = 0x8011044C
	COMStudent_E_CANT_SUBSCRIBE_TO_COMPONENT                                    Handle        = 0x8011044D
	COMStudent_E_EVENTCLASS_CANT_BE_SUBSCRIBER                                  Handle        = 0x8011044E
	COMStudent_E_LIB_APP_PROXY_INCOMPATIBLE                                     Handle        = 0x8011044F
	COMStudent_E_BASE_PARTITION_ONLY                                            Handle        = 0x80110450
	COMStudent_E_START_APP_DISABLED                                             Handle        = 0x80110451
	COMStudent_E_CAT_DUPLICATE_PARTITION_NAME                                   Handle        = 0x80110457
	COMStudent_E_CAT_INVALID_PARTITION_NAME                                     Handle        = 0x80110458
	COMStudent_E_CAT_PARTITION_IN_USE                                           Handle        = 0x80110459
	COMStudent_E_FILE_PARTITION_DUPLICATE_FILES                                 Handle        = 0x8011045A
	COMStudent_E_CAT_IMPORTED_COMPONENTS_NOT_ALLOWED                            Handle        = 0x8011045B
	COMStudent_E_AMBIGUOUS_APPLICATION_NAME                                     Handle        = 0x8011045C
	COMStudent_E_AMBIGUOUS_PARTITION_NAME                                       Handle        = 0x8011045D
	COMStudent_E_REGDB_NOTINITIALIZED                                           Handle        = 0x80110472
	COMStudent_E_REGDB_NOTOPEN                                                  Handle        = 0x80110473
	COMStudent_E_REGDB_SYSTEMERR                                                Handle        = 0x80110474
	COMStudent_E_REGDB_ALREADYRUNNING                                           Handle        = 0x80110475
	COMStudent_E_MIG_VERSIONNOTSUPPORTED                                        Handle        = 0x80110480
	COMStudent_E_MIG_SCHEMANOTFOUND                                             Handle        = 0x80110481
	COMStudent_E_CAT_BITNESSMISMATCH                                            Handle        = 0x80110482
	COMStudent_E_CAT_UNACCEPTABLEBITNESS                                        Handle        = 0x80110483
	COMStudent_E_CAT_WRONGAPPBITNESS                                            Handle        = 0x80110484
	COMStudent_E_CAT_PAUSE_RESUME_NOT_SUPPORTED                                 Handle        = 0x80110485
	COMStudent_E_CAT_SERVERFAULT                                                Handle        = 0x80110486
	...
	COMStudent_E_OBJECT_PARENT_MISSING                                          Handle        = 0x80110808
	COMStudent_E_OBJECT_DOES_NOT_EXIST                                          Handle        = 0x80110809
	COMStudent_E_APP_NOT_RUNNING                                                Handle        = 0x8011080A
	COMStudent_E_INVALID_PARTITION                                              Handle        = 0x8011080B
	COMStudent_E_SVCAPP_NOT_POOLABLE_OR_RECYCLABLE                              Handle        = 0x8011080D
	COMStudent_E_USER_IN_SET                                                    Handle        = 0x8011080E
	COMStudent_E_CANTRECYCLELIBRARYAPPS                                         Handle        = 0x8011080F
	COMStudent_E_CANTRECYCLESERVICEAPPS                                         Handle        = 0x80110811
	COMStudent_E_PROCESSALREADYRECYCLED                                         Handle        = 0x80110812
	COMStudent_E_PAUSEDPROCESSMAYNOTBERECYCLED                                  Handle        = 0x80110813
	COMStudent_E_CANTMAKEINPROCSERVICE                                          Handle        = 0x80110814
	COMStudent_E_PROGIDINUSEBYCLSID                                             Handle        = 0x80110815
	COMStudent_E_DEFAULT_PARTITION_NOT_IN_SET                                   Handle        = 0x80110816
	COMStudent_E_RECYCLEDPROCESSMAYNOTBEPAUSED                                  Handle        = 0x80110817
	COMStudent_E_PARTITION_ACCESSDENIED                                         Handle        = 0x80110818
	COMStudent_E_PARTITION_MSI_ONLY                                             Handle        = 0x80110819
	COMStudent_E_LEGACYCOMPS_NOT_ALLOWED_IN_1_0_FORMAT                          Handle        = 0x8011081A
	COMStudent_E_LEGACYCOMPS_NOT_ALLOWED_IN_NONBASE_PARTITIONS                  Handle        = 0x8011081B
	COMStudent_E_COMP_MOVE_SOURCE                                               Handle        = 0x8011081C
	COMStudent_E_COMP_MOVE_DEST                                                 Handle        = 0x8011081D
	COMStudent_E_COMP_MOVE_PRIVATE                                              Handle        = 0x8011081E
	COMStudent_E_BASEPARTITION_REQUIRED_IN_SET                                  Handle        = 0x8011081F
	COMStudent_E_CANNOT_ALIAS_EVENTCLASS                                        Handle        = 0x80110820
	COMStudent_E_PRIVATE_ACCESSDENIED                                           Handle        = 0x80110821
	COMStudent_E_SAFERINVALID                                                   Handle        = 0x80110822
	COMStudent_E_REGISTRY_ACCESSDENIED                                          Handle        = 0x80110823
	COMStudent_E_PARTITIONS_DISABLED                                            Handle        = 0x80110824
	...
	TPM_E_DELEGATE_Student                                                      Handle        = 0x8028004D
	...
	E_FULL_Student_NOT_SUPPORTED                                                Handle        = 0x80270253
	...
	EAS_E_StudentS_HAVE_BLANK_PASSWORD                                          Handle        = 0x80550007
	EAS_E_StudentS_CANNOT_CHANGE_PASSWORD                                       Handle        = 0x80550008
	EAS_E_LOCAL_CONTROLLED_USERS_CANNOT_CHANGE_PASSWORD                       Handle        = 0x80550009
	EAS_E_PASSWORD_POLICY_NOT_ENFORCEABLE_FOR_CONNECTED_StudentS                Handle        = 0x8055000A
	EAS_E_CONNECTED_StudentS_NEED_TO_CHANGE_PASSWORD                            Handle        = 0x8055000B
	...
	STATUS_LAST_Student                                                         NTStatus      = 0xC0000069
	...
	STATUS_DS_Student_LIMIT_EXCEEDED                                            NTStatus      = 0xC00002C1
	...
	STATUS_StudentLESS_ACCESS_DENIED                                            NTStatus      = 0xC000A204
	...
	STATUS_TPM_DELEGATE_Student                                                 NTStatus      = 0xC029004D
