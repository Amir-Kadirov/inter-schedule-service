...
type JournalServiceClient interface {
	Create(ctx context.Context, in *CreateJournal, opts ...grpc.CallOption) (*JournalPrimaryKey, error)
	...
	Update(ctx context.Context, in *UpdateJournalRequest, opts ...grpc.CallOption) (*JRMessage, error)
	Delete(ctx context.Context, in *JournalPrimaryKey, opts ...grpc.CallOption) (*JRMessage, error)
}
...
func (c *journalServiceClient) Create(ctx context.Context, in *CreateJournal, opts ...grpc.CallOption) (*JournalPrimaryKey, error) {
	out := new(JournalPrimaryKey)
...
func (c *journalServiceClient) Update(ctx context.Context, in *UpdateJournalRequest, opts ...grpc.CallOption) (*JRMessage, error) {
	out := new(JRMessage)
...
func (c *journalServiceClient) Delete(ctx context.Context, in *JournalPrimaryKey, opts ...grpc.CallOption) (*JRMessage, error) {
	out := new(JRMessage)
...
type JournalServiceServer interface {
	Create(context.Context, *CreateJournal) (*JournalPrimaryKey, error)
	...
	Update(context.Context, *UpdateJournalRequest) (*JRMessage, error)
	Delete(context.Context, *JournalPrimaryKey) (*JRMessage, error)
...
func (UnimplementedJournalServiceServer) Create(context.Context, *CreateJournal) (*JournalPrimaryKey, error) {
...
func (UnimplementedJournalServiceServer) Update(context.Context, *UpdateJournalRequest) (*JRMessage, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Update not implemented")
}
func (UnimplementedJournalServiceServer) Delete(context.Context, *JournalPrimaryKey) (*JRMessage, error) {
...
func _JournalService_Update_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(JournalServiceServer).Update(ctx, req.(*UpdateJournalRequest))
	}
	return interceptor(ctx, in, info, handler)
}
