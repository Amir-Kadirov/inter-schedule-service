...
type LessonServiceClient interface {
	Create(ctx context.Context, in *CreateLesson, opts ...grpc.CallOption) (*LessonPrimaryKey, error)
	...
	Update(ctx context.Context, in *UpdateLessonRequest, opts ...grpc.CallOption) (*LSMessage, error)
	Delete(ctx context.Context, in *LessonPrimaryKey, opts ...grpc.CallOption) (*LSMessage, error)
}
...
func (c *lessonServiceClient) Create(ctx context.Context, in *CreateLesson, opts ...grpc.CallOption) (*LessonPrimaryKey, error) {
	out := new(LessonPrimaryKey)
...
func (c *lessonServiceClient) Update(ctx context.Context, in *UpdateLessonRequest, opts ...grpc.CallOption) (*LSMessage, error) {
	out := new(LSMessage)
...
func (c *lessonServiceClient) Delete(ctx context.Context, in *LessonPrimaryKey, opts ...grpc.CallOption) (*LSMessage, error) {
	out := new(LSMessage)
...
type LessonServiceServer interface {
	Create(context.Context, *CreateLesson) (*LessonPrimaryKey, error)
	...
	Update(context.Context, *UpdateLessonRequest) (*LSMessage, error)
	Delete(context.Context, *LessonPrimaryKey) (*LSMessage, error)
...
func (UnimplementedLessonServiceServer) Create(context.Context, *CreateLesson) (*LessonPrimaryKey, error) {
...
func (UnimplementedLessonServiceServer) Update(context.Context, *UpdateLessonRequest) (*LSMessage, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Update not implemented")
}
func (UnimplementedLessonServiceServer) Delete(context.Context, *LessonPrimaryKey) (*LSMessage, error) {
...
func _LessonService_Update_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LessonServiceServer).Update(ctx, req.(*UpdateLessonRequest))
	}
	return interceptor(ctx, in, info, handler)
}
